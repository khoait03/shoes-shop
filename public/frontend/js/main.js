...
document.addEventListener("DOMContentLoaded", function () {
    const tabButtons = document.querySelectorAll(".button-userinfos");
...
function togglesame_PasswordVisibility() {
    var passwordInput = document.getElementById('same_password-input');
    var eyeIcon = document.querySelector('.eye-icons');
