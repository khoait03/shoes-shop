                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                 <tr>
                  <td class="pc-w620-spacing-0-0-40-0" align="center" valign="top" style="padding: 0px 0px 30px 0px;">
                    <img src="{{asset('frontend/img/logo/logo-giay.jpg')}}" class="" width="200px" height="auto" alt="" style="display: block;border: 0;outline: 0;line-height: 100%;-ms-interpolation-mode: bicubic;" />                  </td>
                 </tr>
                </table>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                 <tr>
                   ...
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="left">
                    <tr>
                     <td valign="top" class="pc-font-alt pc-w620-fontSize-16 pc-w620-lineHeight-26" align="left" style="mso-line-height: exactly;line-height: 156%;letter-spacing: -0.2px;font-family: Arial, Helvetica;font-size: 18px;font-weight: normal;color: #ffffff;text-align: left;text-align-last: left;">
                      ...
                      <div><span style="font-size: 14px;color: rgb(29, 29, 30);">Chúng tôi đã nhận được thông tin của bạn trên hệ thống </span><span style="font-size: 14px;font-weight: 700;font-style: normal;color: rgb(29, 29, 30);">Shoes Shop</span><span style="font-size: 14px;color: rgb(29, 29, 30);"> của chúng tôi.</span>
                      </div>    
                             ...
                             <tr>
                              <td valign="top" align="left">
                               <div class="pc-font-alt" style="line-height: 143%;font-family: Arial, Helvetica;font-size: 14px;font-weight: 500;color: #1595e7;text-align: left;text-align-last: left;">
                                ...
                                <div><span style="color: #ffffff;">Hotline: 0123.456.789</span>
                                </div>
                               </div>
                              </td>
                             </tr>
