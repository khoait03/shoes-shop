                   ...
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="left">
                    <tr>
                     <td valign="top" class="pc-font-alt pc-w620-fontSize-16 pc-w620-lineHeight-26" align="left" style="mso-line-height: exactly;line-height: 156%;letter-spacing: -0.2px;font-family: Arial, Helvetica;font-size: 18px;font-weight: normal;color: #ffffff;text-align: left;text-align-last: left;">
                      ...
                      <div><span style="font-size: 14px;color: rgb(29, 29, 30);">Bạn vừa gửi yêu cầu xác nhận email trên hệ thống </span><span style="font-size: 14px;font-weight: 700;font-style: normal;color: rgb(29, 29, 30);">Shoes Shop</span><span style="font-size: 14px;color: rgb(29, 29, 30);"> của chúng tôi vào lúc <b> {{ \Illuminate\Support\Facades\Date::now()->format('d/m/Y H:i:s') }}</b> </span>
                      </div>
                      ...
                      <div><span style="font-size: 14px;color: rgb(29, 29, 30);">Để xác thực email vui lòng nhấp vào link bên dưới: </span>
                      </div>
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                        <td align="center">
                      ...
                      <div><span style="font-size: 14px;color: rgb(29, 29, 30);">﻿Mọi thắc mắc xin vui lòng liên hệ với chúng tôi qua email: <a href="mailto:cskh@gmail.com" target="_blank">cskh@gmail.com</a> để được giải đáp!</span>
                      </div>
                      <div><span style="color: rgb(29, 29, 30);">﻿</span>
                      </div>
                      <div><span style="font-size: 14px;color: rgb(29, 29, 30);">﻿Trân trọng,</span>
                      </div>
                      <div><span style="font-size: 14px;font-weight: 700;font-style: normal;color: rgb(29, 29, 30);">Đội ngũ Shoes Shop</span>
                      </div>
                     </td>
                    </tr>
                   </table>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="left">
                             <tr>
                              <td valign="top" class="pc-font-alt" style="mso-line-height: exactly;line-height: 143%;letter-spacing: -0.2px;font-family: Arial, Helvetica;font-size: 14px;font-weight: normal;color: #ffffff;">
                               <div><span>{{ env('ADDRESS_WEBSITE') }}</span>
                               </div>
                              </td>
                             </tr>
                            </table>
                                            ...
                                            <tr>
                                             <td valign="top" align="left">
                                              <div class="pc-font-alt" style="text-align: left;text-align-last: left;">
                                               <img src="{{asset('/frontend/img/images-email/8ba6bd3503c09274894d347e5cf36242.png')}}" class="" style="display: block;border: 0;outline: 0;line-height: 100%;-ms-interpolation-mode: bicubic;width:18px;height: auto;max-width: 100%;" alt="" />
                                              </div>
                                             </td>
                                            </tr>
                                           </table>
                             ...
                             <tr>
                              <td valign="top" align="left">
                               <div class="pc-font-alt" style="line-height: 143%;font-family: Arial, Helvetica;font-size: 14px;font-weight: 500;color: #1595e7;text-align: left;text-align-last: left;">
                                <div><span style="font-weight: 700;font-style: normal;color: rgb(255, 255, 255);">Website:</span><span> </span><a href="{{env('APP_URL')}}" target="_blank" style="text-decoration: none; color: #1595e7; line-height: 1;"><span style="text-decoration: underline;color: rgb(255, 255, 255);">test.com</span></a><span>﻿</span>
                                </div>
                                <div>
                                    <span style="color: #ffffff;">Hotline: 0123.456.789</span>
                                </div>
                               </div>
                              </td>
                             </tr>
