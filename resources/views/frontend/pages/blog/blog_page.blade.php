...
@if (is_null($getOneCateNews))
    @section('title')
        Tất cả blog tại Sneaker Square
    @endsection
@else
    @section('title')
        {{ $getOneCateNews->cate_news_name }}
    @endsection
    @section('banner')
        <!-- Start banner Area -->
                ...
                <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                    <div class="col-first">
                        ...
                        <nav class="d-flex align-items-center">
                            ...
                            <a
                                href="{{ route('cate.news', $getOneCateNews->cate_news_slug) }}">{{ $getOneCateNews->cate_news_name }}</a>
                        </nav>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-6">
                <div class="container-fluid px-0">
                    @if (!is_null($getOneCateNews))
                        @foreach ($getOneCateNews->getNewsInCate as $lN)
                        ...
                        <div class="paginate d-flex justify-content-center align-items-center gap-3">
                            {{ $getOneCateNews->getNewsInCate->links('frontend.layouts.partials.pagination') }}
                        </div>
                    @else
