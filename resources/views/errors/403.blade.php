...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            ...
            <p class="mb-4 mx-2">Tài Nguyên Không Thể Truy Cập: Xin Lỗi, Bạn Không Được Phép Truy Cập Vào Nội Dung Này.
            </p>
            <button onclick="history.back()" class="btn btn-primary mt-3">
                Quay lại
            </button>
            <div class="mt-4">
                <img src="{{ asset('backend/assets/img/illustrations/girl-doing-yoga-light.png') }}" alt="girl-doing-yoga-light"
