...
class ExportStatisticMonthPrev implements FromCollection , WithHeadings, WithMapping, ShouldAutoSize, WithStyles, WithEvents
{
    private $count = 1; 
    ...
    public function collection()
    {
        ...
        $data = StatisticModel::whereBetween('order_date',[$start_month,$end_month])
