...
class ExportStatisticYear implements FromCollection , WithHeadings, WithMapping, ShouldAutoSize, WithStyles, WithEvents
{
    /**
    ...
    */
    ...
    {
        $today = Carbon::today();
        $subyear = Carbon::now('Asia/Ho_Chi_minh')->startOfYear()->toDateString();
        $data = StatisticModel::whereBetween('order_date',[$subyear,$today])
